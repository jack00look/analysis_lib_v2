...
ACTIVE_MODE = 'KZ_window_moving'  # <-- Set your active mode here. Available: 'ARP_Forward', 'ARP_Forward_Feedback', 'ARP_Backward', 'KZ_det_scan', 'KZ_det_scan_window', 'KZ_window_moving', 'KZ_det_scan_PHC', 'KZ_window_moving_PHC', 'KZ_reps', 'ARPF_reps', 'DMD_density_feedback', 'bubbles', 'bubbles_evolution', 'bubbles_repeat'
...
#SEQS = [28]
SEQS = [28, 29, 30, 31, 32]  # <-- Set your sequence indices here, or set to None to use defaults from MODE_CONFIGS
#EQS = [41]
# -------------------------
